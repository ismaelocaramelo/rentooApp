...
const fetchVendorJs = () => {
  let glob = ['node_modules/jquery/dist/jquery.min.js', 'node_modules/tether/dist/js/tether.min.js', 'node_modules/bootstrap/dist/js/bootstrap.min.js'].concat(bowerFiles(config.selectors.js));
